...
<html lang="en">
  <head>
    ...
    <!-- Main CSS-->
    <link rel="stylesheet" type="text/css" href="studyproject/resources/css/main.css">
    <!-- Font-icon css-->
  ...
  <body class="app sidebar-mini">
    ...
    <script src="studyproject/resources/js/jquery-3.3.1.min.js"></script>
    <script src="studyproject/resources/js/popper.min.js"></script>
    <script src="studyproject/resources/js/bootstrap.min.js"></script>
    <script src="studyproject/resources/js/main.js"></script>
    <!-- The javascript plugin to display page loading on top-->
    <script src="studyproject/resources/js/plugins/pace.min.js"></script>
